...
function Projects() {
    ...
    return <div className="grid sm:gap-8 sm:grid-cols-2 sm:grid-rows-2 place-items-center relative px-2 mx-auto" id="projects">
        <div className="h-100 sm:w-200 bg-amber-200 absolute transform -left-120 sm:block hidden -top-35 -z-5"></div>
        {ProjectElement}
