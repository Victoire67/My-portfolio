...
function About() {
    return <div className="w-full text-black sm:flex grid items-center place-content-center mx-auto p-[20px]" id="about">
        <section className="w-full grid items-center place-content-center sm:w-1/2">
            <img src={myPic} alt="Victoire Ansima Picture" className="mx-auto rounded-full border-16 border-amber-300 shadow-xl" />
